...
txt_hello = 'Здравствуйте! Эта программа поможет вам определить состояние вашего здоровья.'
txt_next = 'Начать'
txt_instruction = ('Это приложение поможет вам определить состояние вашей кардиореспираторной системы с помощью теста Руфье.\n'
                    'Проба Руфье представляет собой загрузочный комплекс, предназначенный для оценки работоспособности сердца при физической нагрузке\n'
                    'у испытуемого, находящегося в положении лежа на спине в течение 5 мин, определяют частоту пуьса за 15 секунд,\n'
                    'затем в течение 45 секунд испытуемый выполняет 30 приседаний.\n'
                    'После окончания нагрузки испытуемый ложится, у него вновь подсчитывается число пульзаций за первые 15 секунд,\n'
                    'а потом - за последние 15 секунд первой минуты периода восстановления.\n'
                    'Важно! Есои в процессе проведения испытания вы почувствуете себя плохо (появится головокружение, шум в\n'
